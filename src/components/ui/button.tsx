...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'default', size = 'default', children, ...props }, ref) => {
    const baseClasses = 'inline-flex items-center justify-center rounded-xl font-semibold transition-all duration-300 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring/50 disabled:opacity-50 disabled:pointer-events-none hover-target';
    ...
    const variantClasses: Record<NonNullable<ButtonProps['variant']>, string> = {
      ...
      outline: 'border border-white/20 text-white hover:bg-white/10 hover:scale-105',
