...
export function ComingSoonPage() {
  ...
  return (
    <>
      {/* Full screen overlay to prevent any background content from showing */}
      <div className="fixed inset-0 z-50 bg-gradient-to-br from-[#1E1B4B] via-[#0F0A2E] to-[#312E81] overflow-hidden">
        {/* Background blobs */}
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 tracking-tight">
              {displayText}
